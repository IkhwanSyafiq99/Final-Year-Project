...
<div class="container-fluid">
  <table class="table" style="border: none">
    ...
    ?>  
      <tr>                           
          <td ><?php echo "<strong>". $readrow["menuname"] ."</strong>"; ?></td>                
...
<br>
    <br>  
      <button type="submit" name="submit" class="btn btn-success; pull-right; border-radius:1px" style="vertical-align: bottom; position: absolute; bottom: 10px; right: 7px; width: 95%; background-color: #FFDE59; border-color: #FFDE59" onclick="return confirm('Are you sure you want to confirm this order is done?');">               
            <?php echo '<span style="color:#080808; text-align:center"> <b>Order Complete</b></span>'; ?>
            </button>
    </form>     
