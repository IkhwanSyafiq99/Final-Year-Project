<?php 
  ...
  if (isset($_POST["submit"])){
    if (!empty($_POST["search"])){
        ...
        header("location:homecustomer.php?search=".$query);        
    }
  }  
?>
<!DOCTYPE html>
...
<body>
        ...
        <div class="jumbotron" style="background-color: #F5F5F5">
            <center>
                <h3> <font>Menu</font></h3>
                    ...
                    <form autocomplete="off" class="" action="homecustomer.php" method="get">
    ...
    <div id="myModal" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
         ...
         <a href="shoppingcart.php" class="material-icons floating-btn"><i class="glyphicon glyphicon-shopping-cart"></i></a>
      ...
      <nav>
          ...
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              ...
              echo "<li><a href=\"homecustomer.php?page=$i\">$i</a></li>";
          ?>
          <?php if ($page==$total_pages) { ?>
            <li class="disabled"><span aria-hidden="true">»</span></li>
          <?php } else { ?>
            <li><a href="homecustomer.php?page=<?php echo $page+1 ?>" aria-label="Previous"><span aria-hidden="true">»</span></a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
